    ...
    competitions: [
        {
            ...
            synopsis:  "<p>"
                            +"<b>Astro Bowl</b>"
                            +"<p>"
                                +"What would happen if the laws of Physics were given a twist? What would happen if the forbidden apple would not have fallen on Newton’s head?" 
                                +"<br>"
                                +"Is “Anti-Gravity” actually a thing?  How would the solar system operate if Kepler’s Laws were removed? Can you actually enter a black hole using teleportation or wormholes? If multiverse is actually a thing, could your copy be living in some other part of the cosmos where anti-gravitational force exists?"
                                +"<br>"
                                +"Are you ready for some mind-boggling hypothetical situations where you apply Physics, the OTHER WAY ROUND!! Hop into this voyager as we offer a set of Anti-Physics questions. After all, the “bowl” is in your hand!"
                            +"</p>"
                            +"<b>Messier Marathon</b>"
                            +"<p>"
                                +"So are you one of those who sneaks out of your room during night hours and wander along gazing at the sky, trying to build up your imagination? Well folks then this is a perfect game for you to play, a hunt for the stars!"
                                +"<br>"
                                +"Participants need to set themselves on a voyage of different celestial bodies and conquer to best of their capabilities. So, are you ready for this mission to get kicked off? See you at the battle field."
                                +"<br>"
                                +"A basic tutorial session would be held on handling of telescope and any further enhancements of the skills would be student’s personal interest."
                            +"</p>"
                        +"</p>",
        ...
        
        {
            ...
            payName: "RST",
            eventDate: "19<sup>th</sup> Jan 2018",
            eventVenue: "The LNMIIT, Jaipur",
            memberUpperLimit: 2,
            memberLowerLimit: 2,
            prizeWorth: '₹ 20,000/-',
        ...
        },
        {
            ...
            payName: "TQ",
            eventDate: "20<sup>th</sup> Jan 2018",
            eventVenue: "The LNMIIT, Jaipur",
            memberUpperLimit: 2,
            memberLowerLimit: 1,
            prizeWorth: '₹ 40,000/-',
            ...
            eventDescription: "<p>"
                                    +"<ol>"
                                        +"<li>The Quest will be held in 2 rounds, both these rounds will take place back to back at LNMIIT during Plinth.</li>"
                                        +"<li>The final round will be between the top 8 teams from Prelims.</li>"
                                        +"<li>The decision of Quizmaster will be final and binding.</li>"
                                    +"</ol>"
                                +"</p>",
            rules: "<p>"
                        +"<b>General Rules </b>"
        ...
        
        {
            ...
            rules: "<p>"
                        ...
                        +"<ol>"
                            +"<li>The bot should not exceed the dimension 750mm x 750mm x 1000mm (l x b x h) at any point during the match.</li>"
                            +"<li>External device used for control are not included in the size constraint.</li>"
                            +"<li>The weight of bot should not exceed 60Kg, including the weight of pneumatic source/tanks.</li>"
        ...
        },
        {
            ...
            eventDescription: "<p>"
                                    +"<b>Problem Statement</b>"
                                    +"<p>"
                                        +"Build a manually controlled bot capable of playing soccer on an arena specially designed for the robotic soccer match."
                                    +"</p>"
            ...
            rules: "<p>"
                        ...
                        +"<ol>"
                            ...
                            +"<li>Each robot should not exceed by max 30cm.</li>"
                            +"<li>The start zone for the single robot is 500mm x 500mm.</li>"
                            +"<li>The robot can extended to a dimension of 500mm x 500mm x 500mm max (independently) once it crosses the start zone.</li>"
                            +"<li>The robots are not allowed to use grippers or actuations which are intended to harm the opponent’s robot.</li>"
                            +"<li>Robot must not: "
                                +"<ul>"
                        ...
                        +"<b>Violation And Disqualification</b>"
                        +"<ol>"
        ...
        },
        {
            ...
            eventDescription: "<p>"
                                    +"<b>Problem Statement</b>"
                                    +"<p>"
                                        +"Build an autonomous robot which can follow a black line and keep track of directions. While going through the maze. It has to analyze the path in the dry run and has to go through the maze from the starting point to the ending point in minimum possible time."
                                    +"</p>"
        ...
        },
        {
            ...
            eventDescription: "<p>"
                                    +"<b>Problem Statement</b>"
                                    +"<p>"
                                        +"Design and make a wireless remote controlled aircraft (using electric motors only), which has all three degrees of freedom including yaw, pitch and roll and that can complete a specified path and perform manoeuvres in the minimum possible time."
                                    +"</p>"
                                    +"<b>GamePlay</b>"
                                    +"<ol>"
                                    ...
                                    +"<ol>"
                                        ...
                                        +"</li>"                                       
                                    +"</ol>"
                                    +"<b>Spot ​Landing:​​ ​(Max​ ​Points​ ​50,​ ​30,​ ​20)</b>"
                                    +"<ol>"
                                    ...
                                    +"</ol>"
                                    +"<b>Materials​​ ​​and​​ ​​services​​ to be ​​provided"
                                    +"<ol>"
        ...
        },
        {
            ...
            eventDescription: "<p>"
                                    +"<b>Problem Statement</b>"
                                    +"<p>"
                                        +"Build a robot that is capable of picking up blocks having hooks and depositing it on the conveyor assembly, also make conveyor assembly which carries the blocks to pits."
                                    +"</p>"
                                    +"<b>Game Play</b>"
